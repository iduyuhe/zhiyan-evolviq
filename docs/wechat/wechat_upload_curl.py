...
COVER = "E:/agent_industry/zhiyan/docs/wechat/cover_s3_dual_stage.jpg"
...
# 3. cover article-img -> body header url (uploadimg)
...
html_path = "E:/agent_industry/zhiyan/docs/wechat/article_s3_dual_stage.html"
...
articles = [{
    "title": "48小时双阶段收口：越用越懂你的工业智能体",
    "thumb_media_id": THUMB,
    "author": "杜玉河",
    "digest": "S2 信任爬梯收口、外部真实反馈 48 小时闭环、S3 智能推荐六层全交付，生态 N=0 破冰实证。",
    "show_cover_pic": 1,
    "content": html,
    "content_source_url": "",
    "need_open_comment": 0,
...
data_path = "E:/agent_industry/zhiyan/docs/wechat/draft_s3_dual_stage.json"

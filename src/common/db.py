...
async def init_db() -> bool:
    ...
    from src.runtime.models import agent_session, behavior_event, bom_upload, env_subscription, feedback, platform_insight, supply_chain, tenant, tenant_usage  # noqa: F401
